...
public enum Translator {
    ...
    ,   GAME_INVALIDSCOREBOARD                              ("Game.invalidScoreboard")
    ,   GAME_INVALIDECONOMY                                 ("Game.invalidEconomy")
    ,   GAME_STOP_REWARD_SING                               ("Game.Stop.Reward.Sing", String.class)
    ,   GAME_STOP_REWARD_PLUR                               ("Game.Stop.Reward.Plur", String.class)
    ...
    ,   GAME_HIGHLIGHTGAMESTART                             ("Game.highlightGameStart", String.class, String.class, String.class, String.class)
    ,   GAME_ACTIONBAR_ERROR                                ("Game.Actionbar.Error")
    ,   GAME_ACTIONBAR_FULLINVENTORY                        ("Game.Actionbar.fullInventory")
    ,   GAME_ACTIONBAR_REWARDING                            ("Game.Actionbar.Rewarding")
    ...
    ,   GAME_ACTIONBAR_EDITMODE                             ("Game.Actionbar.editMode")
    ...
    ,   GAME_HOLO_SCORE1                                    ("Game.Holo.Score1", String.class, String.class)
    ,   GAME_HOLO_SCORE2                                    ("Game.Holo.Score2")
    ,   GAME_HOLO_STREAK1                                   ("Game.Holo.Streak1", String.class, String.class)
    ,   GAME_HOLO_STREAK2                                   ("Game.Holo.Streak2")
    ,   GAME_HOLO_MOLESHIT1                                 ("Game.Holo.molesHit1", String.class, String.class)
    ...
    ,   COMMANDS_TIPS_TOGGLESCOREBOARD                      ("Commands.Tips.toggleScoreboard")
    ,   COMMANDS_TIPS_HOLOCREATEROW                         ("Commands.Tips.holoCreateRow")
    ,   COMMANDS_TIPS_HOLO_CREATE_TYPE1                     ("Commands.Tips.Holo.Create.Type1")
    ,   COMMANDS_TIPS_HOLO_CREATE_TYPE2                     ("Commands.Tips.Holo.Create.Type2")
    ,   COMMANDS_TIPS_HOLO_CREATE_TYPE3                     ("Commands.Tips.Holo.Create.Type3")
    ,   COMMANDS_TIPS_HOLO_CREATE_HOLOID                    ("Commands.Tips.Holo.Create.holoID")
    ,   COMMANDS_TIPS_HOLOID                                ("Commands.Tips.holoID", Game.class, String.class)
    ,   COMMANDS_GAME                                       ("Commands.Game")
    ...
    ,   COMMANDS_BUY_CONFIRMATION_SING                      ("Commands.Buy.Confirmation.Sing")
    ,   COMMANDS_BUY_CONFIRMATION_PLUR                      ("Commands.Buy.Confirmation.Plur")
    ,   COMMANDS_BUY_LOWECONOMY_SING                        ("Commands.Buy.lowEconomy.Sing")
    ,   COMMANDS_BUY_LOWECONOMY_PLUR                        ("Commands.Buy.lowEconomy.Plur")
    ...
    ,   COMMANDS_HOLO                                       ("Commands.Holo")
    ,   COMMANDS_HOLO_CREATE                                ("Commands.Holo.Create")
    ,   COMMANDS_HOLO_CREATE_HOLOID                         ("Commands.Holo.Create.holoId")
    ,   COMMANDS_HOLO_CREATE_TYPE                           ("Commands.Holo.Create.Type")
    ,   COMMANDS_HOLO_CREATE_ROWNUMBERS                     ("Commands.Holo.Create.rowNumbers")
    ,   COMMANDS_HOLO_CREATE_SUCCESS                        ("Commands.Holo.Create.Success")
    ,   COMMANDS_HOLO_CREATE_ERROR                          ("Commands.Holo.Create.Error", String.class)
    ...
    ,   COMMANDS_HOLO_HOLONOTFOUND                          ("Commands.Holo.holoNotFound")
    ...
    ,   COMMANDS_SETTINGS_JACKPOTSPAWNCHANCE_ERROR          ("Commands.Settings.jackpotSpawnChance.Error")
    ...
    ,   COMMANDS_EDITGRID                                   ("Commands.editGrid")
    ,   COMMANDS_EDITGRID_SUCCESS                           ("Commands.editGrid.Success", String.class)
    ...
    ,   HOLOGRAM_ARMORSTANDTYPE_SCORE                       ("Hologram.armorStandType.Score")
    ,   HOLOGRAM_ARMORSTANDTYPE_STREAK                      ("Hologram.armorStandType.Streak")
    ,   HOLOGRAM_ARMORSTANDTYPE_MOLESHIT                    ("Hologram.armorStandType.molesHit")
    ,   REWARDS_TYPE_INVALID_INT                            ("Rewards.Type.Invalid.Int", String.class, String.class)
